    ...
    <nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        <x-nav-link :href="route('dcurrencies.index')" :active="request()->routeIs('currencies.*')">
                        ...
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <button class="flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                                    <div>
                                        @if (App::isLocale('en'))
                                            <i class="flag-icon flag-icon-us mr-1"></i> EN
                                        @elseif (App::isLocale('tr'))
                                            <i class="flag-icon flag-icon-tr mr-1"></i> TR
                                        @endif
                                    </div>
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('locale', 'tr')">
                                    <i class="flag-icon flag-icon-tr mr-1"></i> Türkçe
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                    </div>
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('converter')" :active="request()->routeIs('converter')">
                    <i class="fas fa-exchange-alt mr-2"></i>
                    {{ __('Döviz Çevirici') }}
                </x-responsive-nav-link>
